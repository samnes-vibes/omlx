...
class ModelSettings:
    ...
    Attributes:
        ...
        mtp_draft_depth: Number of chained MTP-head drafts per verify cycle (1-8,
    ...
    # Draft depth for native MTP: the MTP head is applied autoregressively
    # this many times per verify cycle, so one backbone forward verifies
    # depth+1 positions (expected tokens/cycle: 1 + p + p^2 + ... + p^depth).
